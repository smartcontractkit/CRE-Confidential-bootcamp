...
# 🖥️ Before the Bootcamp

- [Environment Setup](setup/setup-instructions.md)

# 🎬 Getting Started

- [Welcome to the CRE Confidential Bootcamp](setup/welcome.md)
- [Stay Connected](setup/stay-connected.md)
- [CRE CLI Quick Setup](setup/cre-cli-setup.md)
